...
update_course = input("Enter a course name to update: ")
if update_course in student["courses"]:
    new_score = input("Enter the new score: ")
    while not new_score.isdigit() or int(new_score) < 0 or int(new_score) > 100:
        new_score = input("Invalid score. Enter a number between 0 and 100: ")
    old_score = student["courses"][update_course]
    student["courses"][update_course] = int(new_score)
